...
import com.staffrakho.databinding.FragmentShortListedProfileBinding
...
class ShortListedProfileFragment : BaseFragment() {

    lateinit var binding: FragmentShortListedProfileBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentShortListedProfileBinding.inflate(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (!isNetworkAvailable()) {
            ...
            getShortListedProfile()
        }

    }

    private fun getShortListedProfile() {
        binding.tvProgressBar.visibility = View.VISIBLE

        lifecycleScope.launch {
            employerViewModel.getShortListedProfile(
                ...
                if (jsonObjectData != null) {
                    try {
                        ...
                        binding.shortListedRecyclerView.adapter =
                            UserProfileAdapter(jobList.data, requireActivity(), AppConstant.SHORTLISTED_PROFILE_SCREEN)
                        binding.shortListedRecyclerView.layoutManager = LinearLayoutManager(requireContext())
